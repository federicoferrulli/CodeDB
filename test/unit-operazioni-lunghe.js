...
module.exports = (async () => {
  ...
  await prova('ogni operazione lunga dichiara quali punti usa', () => {
    ...
    assert.strictEqual(eventi.length, 13, `attesi 13 eventi, trovati ${eventi.length}: ${eventi.join(', ')}`);
  ...
  await prova('i tredici eventi non sono rimasti anche sulla via generica', () => {
